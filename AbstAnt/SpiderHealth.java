...
/**
 * Write a description of class SpiderHealth here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class SpiderHealth extends HealthBar
{
    /**
     * Act - do whatever the SpiderHealth wants to do. This method is called whenever
     ...
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    public SpiderHealth(Spider o, int maxHeath){
